    ...
    return (
      <div>
        <p>
          ...
          displayed as P-1, S12.
        </p>
        <HelpImage
          caption="List organizational view"
          height={ 600 }
          image={ ListViewImg }
          legend="List organizational view: 1) level selection dropdown, 2) filter options,
          3) view item button"
        />
        <p>
        ...
        <HelpImage
          ...
          legend="Microscopy specific fields can be toggled via the dropdown at 1)"
        />
        <p>
        ...
        <HelpImage
          ...
          legend="Refresh the list of available samples by clicking 1)"
        />
      </div>
    );
  }
